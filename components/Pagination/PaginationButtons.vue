...
import {extractFirstNumbers} from "../../utils/utilsFunction";
import SwipePageButton from "../SwipePageButton/SwipePageButton.vue";
import SelectPageButton from "../SelectPageButton/SelectPageButton.vue";
